...
const CandidateDashboard = () => {
  ...
  const applications = [
    ...
    },
    {
      ...
      status: "Rejected",
      date: "8 days ago",
      logo: "/uploads/logos/netflix.png",
    },
  ];
                  ...
                  >
                    ...
                    <div className="sm:text-right">
                      ...
                      >
                        ...
                        {application.status === "Applied" && <FaClock />}
                      ...
                      >
                        ...
                        <div className="mt-4 space-y-2">
                          ...
                          <p className="flex items-start gap-2 text-sm text-gray-600">
                            ...
                            <span>
                              {interview.time || "Time not available"}
                            </span>
                          </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-700 mt-1">
                    Please make sure you are available at the scheduled date
                    and time. Check the interview type and meeting details
                    above.
                  </p>
                </div>
              </div>
